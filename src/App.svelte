...
<div class="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center p-4">
  {#if !showCard}
    ...
    <div class="w-full max-w-4xl">
      <h1 class="text-4xl md:text-5xl font-bold text-white text-center mb-8 md:mb-12">
        Planning Poker
      </h1>
      ...
      <p class="text-white text-center mt-8 text-sm md:text-base opacity-90">
  ...
  {:else}
    ...
    <div class="w-full h-screen flex flex-col items-center justify-center p-4">
      <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-12 aspect-[2/3] flex items-center justify-center max-w-md w-full">
